#!/usr/bin/env python3
"""
Correct test of case-insensitive validation logic
"""
...
def test_case_insensitive_logic():
    ...
    test_cases = [
        ...
        ('Coca Cola', False), # Exact match - should fail
        ('coca cola', False), # Case-insensitive match - should fail
        ('COCa COLA', False), # Case-insensitive match - should fail
        ('bread2', True),     # Different name - should pass
        ('Bread', False),     # Case-insensitive match - should fail
        ('bread', False),     # Case-insensitive match - should fail
        ('Milk 2', True),    # Different name - should pass
    ]
...
def test_view_validation_logic():
    ...
    test_cases = [
        ...
        ('Coca Cola', False, 'Exact duplicate'),
        ('coca cola', False, 'Case-insensitive duplicate'),
        ('Coca', True, 'Different product (partial match)'),
        ('', False, 'Empty name'),
        ('T', False, 'Too short'),
    ]
