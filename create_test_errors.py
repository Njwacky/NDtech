#!/usr/bin/env python
"""
Script to create test errors for the NDtechTrack error tracking system.
This script generates various types of errors to test the error monitoring capabilities.
"""
...
from nano.models import ErrorLog, DeviceConnection, UserActivity
        ...
        for _ in range(random.randint(5, 20)):
            try:
                ...
                activity = UserActivity.objects.create(
                    ...
                    device_connection=connection,
                    metadata={'test_data': True, 'generated_by': 'create_test_errors.py'},
...
def create_automated_issues():
    ...
    from nano.models import Notification
